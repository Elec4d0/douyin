...
func serviceInfo() *kitex.ServiceInfo {
	return videoInfoProtoBufServiceInfo
}

var videoInfoProtoBufServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "videoInfo_protoBuf"
	handlerType := (*api.VideoInfoProtoBuf)(nil)
...
func getVideoInfoListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoInfoProtoBuf).GetVideoInfoList(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GetVideoInfoListArgs:
		success, err := handler.(api.VideoInfoProtoBuf).GetVideoInfoList(ctx, s.Req)
		if err != nil {
			return err
		}
...
var GetVideoInfoListResult_Success_DEFAULT *api.VideoInfoGetAuthorVideoInfoListResponse
...
func (p *GetVideoInfoListResult) GetSuccess() *api.VideoInfoGetAuthorVideoInfoListResponse {
	if !p.IsSetSuccess() {
...
func getVideoInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoInfoProtoBuf).GetVideoInfo(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetVideoInfoArgs:
		success, err := handler.(api.VideoInfoProtoBuf).GetVideoInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getFeedHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoInfoProtoBuf).GetFeed(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFeedArgs:
		success, err := handler.(api.VideoInfoProtoBuf).GetFeed(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getAuthorVideoInfoListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoInfoProtoBuf).GetAuthorVideoInfoList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetAuthorVideoInfoListArgs:
		success, err := handler.(api.VideoInfoProtoBuf).GetAuthorVideoInfoList(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *kClient) GetVideoInfoList(ctx context.Context, Req *api.VideoInfoGetVideoInfoListRequest) (r *api.VideoInfoGetAuthorVideoInfoListResponse, err error) {
