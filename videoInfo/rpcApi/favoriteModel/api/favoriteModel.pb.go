...
type FavoriteModelQueryIsUserFavoriteResponse struct {
	...
	StatusCode     int32   `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`   // 状态码，0-成功，其他值-失败
	StatusMsg      *string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3,oneof" json:"status_msg,omitempty"` // 返回状态描述
	IsUserFavorite bool    `protobuf:"varint,3,opt,name=is_user_favorite,json=isUserFavorite,proto3" json:"is_user_favorite,omitempty"`
}
...
func (x *FavoriteModelQueryUserFavoriteCountListRequest) GetUserIdList() []int64 {
	if x != nil {
		return x.UserIdList
	}
	return nil
...
func (x *FavoriteModelQueryUserFavoriteCountRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type FavoriteModelQueryUserFavoriteCountResponse struct {
	...
	StatusCode     int32   `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`   // 状态码，0-成功，其他值-失败
	StatusMsg      *string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3,oneof" json:"status_msg,omitempty"` // 返回状态描述
	TotalFavorited int64   `protobuf:"varint,3,opt,name=total_favorited,json=totalFavorited,proto3" json:"total_favorited,omitempty"`
...
var file_favoriteModel_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x73, 0x55, 0x73,
	...
	0x49, 0x64, 0x22, 0xd7, 0x01, 0x0a, 0x31, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x46, 0x61, 0x76,
	0x6f, 0x72, 0x69, 0x74, 0x65, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d,
