...
type DouyinPublishListResponse struct {
	...
	VideoList  []*Video `protobuf:"bytes,3,rep,name=video_list,json=videoList,proto3" json:"video_list"`       // 用户发布的视频列表
}
...
type DouyinFeedRequest struct {
	...
	UserId     int64  `protobuf:"varint,2,opt,name=userId,proto3" json:"userId,omitempty"`                                 // 可选参数，登录用户设置
}
...
type DouyinPublishActionRequest struct {
	...
	UserId int64  `protobuf:"varint,1,opt,name=userId,proto3" json:"userId,omitempty"` // 用户鉴权token
...
var file_video_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x36, 0x0a,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x99, 0x01, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x88, 0x01, 0x01, 0x12, 0x25, 0x0a, 0x0a, 0x76,
	...
	0x67, 0x22, 0x63, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x64,
	...
	0x0a, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x16,
	0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x6c, 0x61, 0x74, 0x65, 0x73,
	0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xc1, 0x01, 0x0a, 0x14, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x09, 0x6e,
	0x65, 0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x48, 0x01,
	0x52, 0x08, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x42, 0x0d, 0x0a,
	0x0b, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x6d, 0x73, 0x67, 0x42, 0x0c, 0x0a, 0x0a,
	0x5f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0x61, 0x0a, 0x1d, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x75,
	...
	0x6d, 0x73, 0x67, 0x22, 0xf1, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a,
	0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e,
	...
	,
...
var file_video_proto_goTypes = []interface{}{
	(*DouyinPublishListRequest)(nil),    // 0: douyin_publish_list_request
	(*DouyinPublishListResponse)(nil),   // 1: douyin_publish_list_response
	(*DouyinFeedRequest)(nil),           // 2: douyin_feed_request
	(*DouyinFeedResponse)(nil),          // 3: douyin_feed_response
...
var file_video_proto_depIdxs = []int32{
	6, // 0: douyin_publish_list_response.video_list:type_name -> Video
	6, // 1: douyin_feed_response.video_list:type_name -> Video
	7, // 2: Video.author:type_name -> User
	2, // 3: feed_protoBuf.getFeed:input_type -> douyin_feed_request
	4, // 4: feed_protoBuf.publishVideo:input_type -> douyin_publish_action_request
	0, // 5: feed_protoBuf.getAuthorVideoList:input_type -> douyin_publish_list_request
	3, // 6: feed_protoBuf.getFeed:output_type -> douyin_feed_response
	5, // 7: feed_protoBuf.publishVideo:output_type -> douyin_publish_action_response
	1, // 8: feed_protoBuf.getAuthorVideoList:output_type -> douyin_publish_list_response
...
type FeedProtoBuf interface {
	GetFeed(ctx context.Context, req *DouyinFeedRequest) (res *DouyinFeedResponse, err error)
	PublishVideo(ctx context.Context, req *DouyinPublishActionRequest) (res *DouyinPublishActionResponse, err error)
	GetAuthorVideoList(ctx context.Context, req *DouyinPublishListRequest) (res *DouyinPublishListResponse, err error)
}
