...
import (
	"context"
	"gateway/rpcApi/videoPublish/api"
	"gateway/rpcApi/videoPublish/api/videopublishservice"
...
func PublishVideo(userID int64, data []byte, title string) (*api.VideoPublishActionResponse, error) {
	...
	resp, err := videoPublishRpcClient.PublishVideo(context.Background(), rpcReq)
