...
func serviceInfo() *kitex.ServiceInfo {
	return videoModelProtoBufServiceInfo
}

var videoModelProtoBufServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "videoModel_protoBuf"
	handlerType := (*api.VideoModelProtoBuf)(nil)
...
func createVideoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).CreateVideo(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CreateVideoArgs:
		success, err := handler.(api.VideoModelProtoBuf).CreateVideo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func queryAuthorWorkCountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).QueryAuthorWorkCount(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *QueryAuthorWorkCountArgs:
		success, err := handler.(api.VideoModelProtoBuf).QueryAuthorWorkCount(ctx, s.Req)
		if err != nil {
			return err
		}
...
func queryAuthorVideoListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).QueryAuthorVideoList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *QueryAuthorVideoListArgs:
		success, err := handler.(api.VideoModelProtoBuf).QueryAuthorVideoList(ctx, s.Req)
		if err != nil {
			return err
		}
...
func queryVideoListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).QueryVideoList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *QueryVideoListArgs:
		success, err := handler.(api.VideoModelProtoBuf).QueryVideoList(ctx, s.Req)
		if err != nil {
			return err
		}
...
func queryVideoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).QueryVideo(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *QueryVideoArgs:
		success, err := handler.(api.VideoModelProtoBuf).QueryVideo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func queryVideoFeedHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VideoModelProtoBuf).QueryVideoFeed(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *QueryVideoFeedArgs:
		success, err := handler.(api.VideoModelProtoBuf).QueryVideoFeed(ctx, s.Req)
		if err != nil {
			return err
		}
